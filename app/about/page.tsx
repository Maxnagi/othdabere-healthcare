...
export default function About() {
  return (
    <>
      ...
      <section style={{ background: "linear-gradient(135deg,#0B2545 0%,#0D9488 100%)", padding: "64px 0" }}>
        <div className="container">
          <ScrollReveal>
            <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: 32 }}>
              <div style={{ flex: 1, minWidth: 260 }}>
                <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.25)", padding: "6px 14px", borderRadius: 50, marginBottom: 16 }}>
                  <span style={{ width: 7, height: 7, borderRadius: "50%", background: "#2DD4BF", display: "inline-block" }} />
                  <span style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", fontWeight: 700, fontSize: "0.7rem", letterSpacing: "0.13em", textTransform: "uppercase", color: "rgba(255,255,255,0.85)" }}>Meet the Founder</span>
                </div>
                <h2 style={{ fontFamily: "'Cormorant Garamond',serif", fontSize: "clamp(1.8rem,4vw,2.8rem)", fontWeight: 700, color: "white", lineHeight: 1.15, marginBottom: 14 }}>
                  The Heart Behind OHQHS
                </h2>
                <p style={{ fontFamily: "'Plus Jakarta Sans',sans-serif", color: "rgba(255,255,255,0.78)", fontSize: "0.96rem", lineHeight: 1.76, maxWidth: 520, margin: 0 }}>
                  Dorothy Ohenewa — Registered Nurse, Social Worker and award-winning NHS leader with 15+ years of clinical experience — founded OHQHS to bring compassionate, person-centred care directly into people's homes.
                </p>
              </div>
              <div style={{ flexShrink: 0 }}>
                <Link
                  ...
                  onMouseEnter={e => {
                    ...
                    ;(e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 14px 36px rgba(0,0,0,0.32)"
                  }}
                  onMouseLeave={e => {
                ...
                >
                  👩‍⚕️ Read Her Full Story
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                    <path d="M5 12h14M12 5l7 7-7 7" stroke="#0B2545" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </Link>
              </div>
            </div>
